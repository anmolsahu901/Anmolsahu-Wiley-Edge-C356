...
-- INT                 – use integer data type.
-- DECIMAL             – use DECIMAL datatype to store exact values in decimal format.
...
-- TEXT                – store text data using TEXT datatype.
-- DATE                – introduce you to the DATE datatype and show you some date functions to handle the date data effectively.
-- TIME                – walk you through the features of TIME datatype and use some useful temporal functions to handle time data.
