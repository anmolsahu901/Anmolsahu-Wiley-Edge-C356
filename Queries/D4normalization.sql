...
Example: Consider a table called "Orders" with columns: Order_ID, Product_ID, Product_Name, and Product_Category. 
In 2NF, we need to ensure that the Product_Name and Product_Category depend on the Order_ID 
and not just the Product_ID.
...
-- Example: Let's consider a table called "Customers" with columns: Customer_ID, Product_ID, and Product_Name.
--  In BCNF, we need to split the table into two tables: Customers and Products, as the Product_Name depends on 
--  the Product_ID and not on the Customer_ID.
...
-- Example: Consider a table called "Employees_Projects" with columns: Employee_ID, Project_ID, Employee_Name, 
-- Project_Name, and Hours_Worked. In 4NF, we need to separate the multi-valued dependency between Employee_ID, 
-- Employee_Name, and Hours_Worked.
